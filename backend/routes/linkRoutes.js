...
const unauthorizedPageHtml = `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <title>Unauthorized | BRNK</title>
  ...
  <style>
    ...
    main{text-align:center;padding:24px;max-width:480px}
...
<body>
  <main>
    <h1>Unauthorized</h1>
    <p>This endpoint is not available for direct access.</p>
  </main>
</body>
</html>`;
...
router.get('/', (req, res) => {
  res.status(403).type('html').send(unauthorizedPageHtml);
});
